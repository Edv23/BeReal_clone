...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        ParseSwift.initialize(applicationId: "LtyrAczejoheujXQai5wNoivomLka6BojaqYLDBJ",
                              clientKey: "1AYktmP90A98SZ8RqusK0Hq77vaXZJwYcf0J0TOz",
                              serverURL: URL(string: "https://parseapi.back4app.com")!)
        
//        func initializeParse(customObjectId: Bool = false) {
//            ParseSwift.initialize(applicationId: "laSmOMh0Y74s9JQhqzit3VTT2JdVV6ongVwMSGRe",
//                                  clientKey: "J911YAxxhw3ADKcXfJog2rssDv1JEu5x1uZ6RTlo",
//                                  serverURL: URL(string: "https://parseapi.back4app.com")!)
//        }
